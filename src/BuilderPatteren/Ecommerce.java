...
// created various method in this class
// will create another class for main method--> EcommarceTest
// since want to use this class from outside I created method class separately
// Every method should return something with the object
...
public class Ecommerce {
	...
	public Ecommerce login() {
		...
		return this;// means current class object
	}
